...
namespace Data_service.Migrations
{
    ...
    [Migration("20250120153349_MakeFailureReasonNullableOrDefault")]
    partial class MakeFailureReasonNullableOrDefault
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities_Dtos.DBSets.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Entities_Dtos.DBSets.AdminUser", b =>
                {
                    b.HasBaseType("Entities_Dtos.DBSets.ApplicationUser");
            ...
            modelBuilder.Entity("Entities_Dtos.DBSets.CustomerUser", b =>
                {
                    b.HasBaseType("Entities_Dtos.DBSets.ApplicationUser");
            ...
            modelBuilder.Entity("Entities_Dtos.DBSets.Customer", b =>
                {
                    b.HasOne("Entities_Dtos.DBSets.CustomerUser", "CustomerUser")
                        .WithOne("Customer")
                        .HasForeignKey("Entities_Dtos.DBSets.Customer", "CustomerUserId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Entities_Dtos.DBSets.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Entities_Dtos.DBSets.AdminUser", b =>
                {
                    b.HasOne("Entities_Dtos.DBSets.ApplicationUser", null)
                        .WithOne()
                        .HasForeignKey("Entities_Dtos.DBSets.AdminUser", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Entities_Dtos.DBSets.CustomerUser", b =>
                {
                    b.HasOne("Entities_Dtos.DBSets.ApplicationUser", null)
                        .WithOne()
                        .HasForeignKey("Entities_Dtos.DBSets.CustomerUser", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
